    ...
    <div class="wrapper">
        ...
        if(isset($_POST['submit'])){
            ...
            if(isset($_FILES['image']['name'])){
                ...
                if($image_name!=""){
                  //image available upload the new image and remove current iamge
                  ...
                  if($current_image!=""){
                    ...
                    //if failed to remove dispaly messaage and stop process
                    if($remove==false){
            ...
            //check whether query exected or not
            if($res2==true){
                //category updated
