...
<br><br>
         ...
         <table class="tbl-full">
                  ...
                  //create a serial number assign value as 1
                  $sn=1;
                   //check whether we have data in data baase or not
                   if($count>0){
                        ...
                        ?>
                              ...
                              <tr>
                                 ...
                                 <td> 
                                    ...
                                    if($image_name!=""){
                                       ?>
                                       <img src="<?php echo SITEURL; ?>images/cateory/<?php echo $image_name;?>" width="90px">
                                       <?php
                                       //display the image 
                                    }
                                    else{
